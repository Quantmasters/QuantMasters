...
public class Testimony extends AppCompatActivity {
    ...
    Testimony_Adapter video_list_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Testimony.this, LinearLayoutManager.VERTICAL, false);
        recycler_views.setLayoutManager(mLayoutManager);
        recycler_views.setHasFixedSize(true);


        video_list_adapter = new Testimony_Adapter(this, video_lists);
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/testimony/videos/all",
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar2.setVisibility(View.GONE);
                new LovelyStandardDialog(Testimony.this)
