...
public class Test_Chapters extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();
         super_group_id = intent.getExtras().getString("super_group_id");
        String chapter_title = intent.getExtras().getString("chapter_title");
        progressBar = (ProgressBar) findViewById(R.id.spin_kit);
        db = new DatabaseHandler(this);
        TextView chapter_name = findViewById(R.id.chapter_name);
        chapter_name.setText(chapter_title);
        ...
        float width = paint.measureText(chapter_title);
        ...
        test_chapter_adapter = new Test_Chapter_Adapter(this, chapter_list);
    ...
    private void Load(final String token, final String sgi) {

        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/test/progression/groups/" + sgi,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                new LovelyStandardDialog(Test_Chapters.this)
