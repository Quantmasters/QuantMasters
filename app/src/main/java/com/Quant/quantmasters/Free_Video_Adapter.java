...
public class Free_Video_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Free_Video_Adapter(Context context, List<Video_List> video_lists) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        ((News_Card_5) holder).layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showDialog();
                Log.d("Response", "good");
                StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/learn/sample/videos/" + vid + "/link",
