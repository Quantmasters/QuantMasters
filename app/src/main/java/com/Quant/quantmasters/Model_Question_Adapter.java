...
public class Model_Question_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<Chapter_List> chapter_lists;
    private Context context;

    public Model_Question_Adapter(Context context, List<Chapter_List> chapter_lists) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        ((News_Card_5) holder).relative.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (feeds.Get_Flag()==1) {
                Intent intent = new Intent(context, Model_Test_Activity.class);
