...
public class Company_Specific_Test extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Company_Specific_Test.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/test/company/paper/" + group_id,
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.setVisibility(View.GONE);
                new LovelyStandardDialog(Company_Specific_Test.this)
    ...
    private void Submit(final String token, final String email, final String marks) {
        ...
        showDialog();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://api.quantmasters.in/test/company/submit/marks",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
