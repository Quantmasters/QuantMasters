...
public class Live_Workshop_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Live_Workshop_Adapter(Context context, List<Video_List> video_lists) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        ((News_Card_5) holder).layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showDialog();
                Log.d("Response", "good");
                StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/learn/workshop/videos/" + vid + "/link",
