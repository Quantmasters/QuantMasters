...
public class Level_Activity extends Activity {
    ...
    Level_Adapter test_chapter_adapter;
    String name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test_chapter_adapter = new Level_Adapter(this, chapter_list);
    ...
    private void Load(final String token, final String gi) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/test/progression/group/" + gi,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                new LovelyStandardDialog(Level_Activity.this)
