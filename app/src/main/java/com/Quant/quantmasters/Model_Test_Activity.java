...
public class Model_Test_Activity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Model_Test_Activity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/test/question/ret/" + group_id,
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.setVisibility(View.GONE);
                new LovelyStandardDialog(Model_Test_Activity.this)
    ...
    private void Submit(final String token, final String email, final String marks) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://api.quantmasters.in/test/answer/submit",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            Log.d("Response", "good1");
                            JSONObject jObj = new JSONObject(response);

                            Log.d("res", response);
                            if (jObj.getString("text").equals("Answer Submitted")) {
                                hideDialog();
                                Intent intent = new Intent(Model_Test_Activity.this, Test_Done.class);
