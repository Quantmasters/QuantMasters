...
public class Test_Chapter_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<Chapter_List> chapter_lists;
    private Context context;

    public Test_Chapter_Adapter(Context context, List<Chapter_List> chapter_lists) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        float width = paint.measureText(feeds.Get_Number());
        ...
        ((News_Card_5) holder).relative.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(feeds.Get_Num()==1){
                    Intent intent = new Intent(context, Test_Chapters.class);
                    intent.putExtra("super_group_id", feeds.Get_Id());
                    intent.putExtra("chapter_title", feeds.Get_Name());
