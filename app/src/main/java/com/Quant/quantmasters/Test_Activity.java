...
public class Test_Activity extends AppCompatActivity {
    ...
    ArrayList<Question_List> question_lists = new ArrayList<Question_List>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog = new ProgressDialog(Test_Activity.this);
       ...
       // getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Test_Activity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/test/progression/paper/" + group_id,
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.setVisibility(View.GONE);
                new LovelyStandardDialog(Test_Activity.this)
    ...
    private void Submit(final String token, final String email, final String marks) {
        ...
        showDialog();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://api.quantmasters.in/test/progression/submit/marks",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            if (jObj.getString("text").equals("Answer Submitted")) {
                                hideDialog();
                                Intent intent = new Intent(Test_Activity.this, Test_Done.class);
