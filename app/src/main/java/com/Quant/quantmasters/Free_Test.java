...
public class Free_Test extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog = new ProgressDialog(Free_Test.this);
      ...
      //  getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Free_Test.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/test/sample/paper/new/" + group_id,
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.setVisibility(View.GONE);
                new LovelyStandardDialog(Free_Test.this)
