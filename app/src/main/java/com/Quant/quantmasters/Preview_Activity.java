...
public class Preview_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grp = Objects.requireNonNull(intent.getExtras()).getString("Video_Group_Id");
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Preview_Activity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/learn/videos/all",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < feedArray.length(); i++) {
                                ...
                                if (grp.equals(feedObj.getString("video_group"))) {
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar2.setVisibility(View.GONE);
                new LovelyStandardDialog(Preview_Activity.this)
