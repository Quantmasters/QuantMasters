...
public class Chapter_Level extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float width = paint.measureText("Chapters");
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/test/progression/super-groups",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < feedArray.length(); i++) {
                                ...
                                chapter_lists.Set_Id(feedObj.getString("super_group_id"));
                                chapter_lists.Set_Name(feedObj.getString("super_group_name"));
                                chapter_lists.Set_Num(1);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                new LovelyStandardDialog(Chapter_Level.this)
