...
public class Review_Activity extends AppCompatActivity {
    ...
    Review_Adapter video_list_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Review_Activity.this, LinearLayoutManager.VERTICAL, false);
        recycler_views.setLayoutManager(mLayoutManager);
        recycler_views.setHasFixedSize(true);


        video_list_adapter = new Review_Adapter(this, video_lists);
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/review/videos/all",
...
//[{"video_id":"6a94f6e9-7674-3d90-81b2-7f9b567a0025","video_name":"Akila's Testimony","video_type":"1","length":"0:33","thumbnail":"/assets/thumbnails/ThmbTAkila.jpg"},
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar2.setVisibility(View.GONE);
                new LovelyStandardDialog(Review_Activity.this)
