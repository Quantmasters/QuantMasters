...
public class Free_Test_Papers extends Activity {
    ...
    Free_Test_Adapter test_chapter_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chapter_name.setText("Free Test");

        TextPaint paint = chapter_name.getPaint();
        float width = paint.measureText("Free Test");
        ...
        test_chapter_adapter = new Free_Test_Adapter(this, chapter_list);
    ...
    private void Load(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://api.quantmasters.in/test/sample/papers",
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                new LovelyStandardDialog(Free_Test_Papers.this)
